...
then
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> MariaDB installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> dnsmasq installed</p>'
  fi
  ...
  then
    ...
    then
      httpdconf+='<p class="bg-danger inset"><span class="glyphicon glyphicon-remove"> </span> comment out &lt;Directory \&gt; block</p>'
    else
      httpdconf+='<p class="bg-success inset"><span class="glyphicon glyphicon-ok"> </span> &lt;Directory /&gt; is commented out</p>'
    fi
    echo $httpdconf
  fi
  ...
  if [[ -s "$HOME/.rvm/scripts/rvm" ]] ; then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> rvm installed</p>'
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> git installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> brew installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> wp-cli installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> npm installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> bower installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> grunt installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> compass installed</p>'
  fi
  ...
  then
    ...
    echo '<p class="bg-success"><span class="glyphicon glyphicon-ok"> </span> sass installed</p>'
  fi
fi